...
article_data = ["0888-7993", "1558-7975", "Accounting Horizons"]
...
try:
    # Article Writer
    if path.exists('Articles-Accounting Horizons.csv') == False:
        articles_file = open('Articles-Accounting Horizons.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Accounting Horizons.csv') == False:
        authors_file = open('Authors-Accounting Horizons.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://meridian.allenpress.com/accounting-horizons/issue/browse-by-year"
driver.get(url)
