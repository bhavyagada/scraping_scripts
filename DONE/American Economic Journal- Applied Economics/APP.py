...
article_data = ["1945-7782", "1945-7790", "American Economic Journal: Applied Economics"]
...
try:
    # Article Writer
    if path.exists('Articles-American Economic Journal Applied Economics.csv') == False:
        articles_file = open('Articles-American Economic Journal Applied Economics.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-American Economic Journal Applied Economics.csv') == False:
        authors_file = open('Authors-American Economic Journal Applied Economics.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://www.aeaweb.org/journals/app/issues"
driver.get(url)
