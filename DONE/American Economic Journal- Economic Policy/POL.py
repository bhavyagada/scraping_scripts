...
article_data = ["1945-7731", "1945-774X", "American Economic Journal: Economic Policy"]
...
try:
    # Article Writer
    if path.exists('Articles-American Economic Journal Economic Policy.csv') == False:
        articles_file = open('Articles-American Economic Journal Economic Policy.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-American Economic Journal Economic Policy.csv') == False:
        authors_file = open('Authors-American Economic Journal Economic Policy.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://www.aeaweb.org/journals/pol/issues"
driver.get(url)
