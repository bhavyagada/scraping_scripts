...
article_data = ["1945-7669", "1945-7685", "American Economic Journal: Microeconomics"]
...
try:
    # Article Writer
    if path.exists('Articles-American Economic Journal Microeconomics.csv') == False:
        articles_file = open('Articles-American Economic Journal Microeconomics.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-American Economic Journal Microeconomics.csv') == False:
        authors_file = open('Authors-American Economic Journal Microeconomics.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://www.aeaweb.org/journals/mic/issues"
driver.get(url)
