...
article_data = ["0002-8282", "1944-7981", "American Economic Review"]
...
try:
    # Article Writer
    if path.exists('Articles-American Economic Review.csv') == False:
        articles_file = open('Articles-American Economic Review.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-American Economic Review.csv') == False:
        authors_file = open('Authors-American Economic Review.csv', mode='a+', newline='', encoding='UTF-8')
