...
article_data = ["1932-6157", "1941-7330", "Annals of Applied Statistics"]
...
try:
    # Article Writer
    if path.exists('Articles-Annals of Applied Statistics.csv') == False:
        articles_file = open('Articles-Annals of Applied Statistics.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Annals of Applied Statistics.csv') == False:
        authors_file = open('Authors-Annals of Applied Statistics.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://projecteuclid.org/journals/annals-of-applied-statistics/issues"
driver.get(url)
