...
article_header = ["issn", "e_issn", "publication_name", "volume", "issue", "document_title", "document_type", 
                "issue_date", "publication_date", "published_date", "digital_object_identifier", "abstract", "keywords"]
article_data = ["0217-4561", "1572-9958", "Asia Pacific Journal of Management"]
...
try:
    # Article Writer
    if path.exists('Articles-Asia Pacific Journal of Management.csv') == False:
        articles_file = open('Articles-Asia Pacific Journal of Management.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Asia Pacific Journal of Management.csv') == False:
        authors_file = open('Authors-Asia Pacific Journal of Management.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/10490/volumes-and-issues"
driver.get(url)
...
for url in issue_urls:
    ...
    for url in article_urls:
        ...
        if url_type != 'text/html':
            ...
            temp_article_list = [volume, issue, document_title, document_type[i], issue_date, publication_date, published_date, digital_object_identifier, abstract, keywords_list]
