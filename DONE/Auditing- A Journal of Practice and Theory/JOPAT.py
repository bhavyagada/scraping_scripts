...
article_data = ["0278-0380", "1558-7991", "Auditing-A Journal of Practice and Theory"]
...
try:
    # Article Writer
    if path.exists('Articles-Auditing - A Journal of Practice and Theory.csv') == False:
        articles_file = open('Articles-Auditing - A Journal of Practice and Theory.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Auditing - A Journal of Practice and Theory.csv') == False:
        authors_file = open('Authors-Auditing - A Journal of Practice and Theory.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://meridian.allenpress.com/ajpt/issue/browse-by-year"
driver.get(url)
