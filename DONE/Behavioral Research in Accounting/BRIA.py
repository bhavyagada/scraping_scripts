...
article_data = ["1050-4753", "1558-8009", "Behavioral Research in Accounting"]
...
try:
    # Article Writer
    if path.exists('Articles-Behavioral Research in Accounting.csv') == False:
        articles_file = open('Articles-Behavioral Research in Accounting.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Behavioral Research in Accounting.csv') == False:
        authors_file = open('Authors-Behavioral Research in Accounting.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://meridian.allenpress.com/bria/issue/browse-by-year"
driver.get(url)
