...
article_data = ["0926-6003", "0926-6003", "Computational Optimization and Applications"]
...
try:
    # Article Writer
    if path.exists('Articles-Computational Optimization and Applications.csv') == False:
        articles_file = open('Articles-Computational Optimization and Applications.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Computational Optimization and Applications.csv') == False:
        authors_file = open('Authors-Computational Optimization and Applications.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/10589/volumes-and-issues"
driver.get(url)
