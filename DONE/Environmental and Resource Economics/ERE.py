...
article_data = ["0924-6460", "1573-1502", "Environmental and Resource Economics"]
...
try:
    # Article Writer
    if path.exists('Articles-Environmental and Resource Economics.csv') == False:
        articles_file = open('Articles-Environmental and Resource Economics.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Environmental and Resource Economics.csv') == False:
        authors_file = open('Authors-Environmental and Resource Economics.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/10640/volumes-and-issues"
driver.get(url)
