...
article_data = ["0949-2984", "1432-1122", "Finance and Stochastics"]
...
try:
    # Article Writer
    if path.exists('Articles-Finance and Stochastics.csv') == False:
        articles_file = open('Articles-Finance and Stochastics.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Finance and Stochastics.csv') == False:
        authors_file = open('Authors-Finance and Stochastics.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/780/volumes-and-issues"
driver.get(url)
