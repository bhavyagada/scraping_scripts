...
article_header = ["issn", "e_issn", "publication_name", "volume", "issue", "document_title", "document_type", 
                ...
                "digital_object_identifier", "abstract", "keywords"]
article_data = ["1568-4539", "1573-2908", "Fuzzy Optimization and Decision Making"]
...
try:
    # Article Writer
    if path.exists('Articles-Fuzzy Optimization and Decision Making.csv') == False:
        articles_file = open('Articles-Fuzzy Optimization and Decision Making.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Fuzzy Optimization and Decision Making.csv') == False:
        authors_file = open('Authors-Fuzzy Optimization and Decision Making.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/10700/volumes-and-issues"
driver.get(url)
...
for url in issue_urls:
    ...
    for url in article_urls:
        ...
        if url_type != 'text/html':
            ...
            temp_article_list = [volume, issue, document_title, document_type[i], issue_date, publication_date, published_date, manuscript_accepted_date, digital_object_identifier, abstract, keywords_list]
