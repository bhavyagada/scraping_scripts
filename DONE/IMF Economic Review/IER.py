...
article_header = ["issn", "e_issn", "publication_name", "volume", "issue", "document_title", "document_type", 
                "issue_date", "publication_date", "published_date", "digital_object_identifier", "abstract", "jel_classification"]
article_data = ["2041-4161", "2041-417X", "IMF Economic Review"]
...
try:
    # Article Writer
    if path.exists('Articles-IMF Economic Review.csv') == False:
        articles_file = open('Articles-IMF Economic Review.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-IMF Economic Review.csv') == False:
        authors_file = open('Authors-IMF Economic Review.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/41308/volumes-and-issues"
driver.get(url)
...
for url in issue_urls:
    ...
    for url in article_urls:
        ...
        if url_type != 'text/html':
            ...
            temp_article_list = [volume, issue, document_title, document_type[i], issue_date, publication_date, published_date, digital_object_identifier, abstract, jel_classification]
