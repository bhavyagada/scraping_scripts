...
article_header = ["issn", "e_issn", "publication_name", "volume", "issue", "document_title", "document_type", 
                "issue_date", "publication_date", "manuscript_accepted_date", "digital_object_identifier", 
                "abstract", "keywords"]
article_data = ["1387-3326", "1572-9419", "Information Systems Frontiers"]
...
try:
    # Article Writer
    if path.exists('Articles-Information Systems Frontiers.csv') == False:
        articles_file = open('Articles-Information Systems Frontiers.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Information Systems Frontiers.csv') == False:
        authors_file = open('Authors-Information Systems Frontiers.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/10796/volumes-and-issues"
driver.get(url)
...
for url in issue_urls:
    ...
    for url in article_urls:
        ...
        if url_type != 'text/html':
            ...
            temp_article_list = [volume, issue, document_title, document_type[i], issue_date, publication_date, manuscript_accepted_date, digital_object_identifier, abstract, keywords_list]
