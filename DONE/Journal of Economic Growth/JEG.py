...
article_data = ["1381-4338", "1573-7020", "Journal of Economic Growth"]
...
try:
    # Article Writer
    if path.exists('Articles-Journal of Economic Growth.csv') == False:
        articles_file = open('Articles-Journal of Economic Growth.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Journal of Economic Growth.csv') == False:
        authors_file = open('Authors-Journal of Economic Growth.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/10887/volumes-and-issues"
driver.get(url)
