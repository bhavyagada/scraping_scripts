...
article_data = ["0022-0515", "2328-8175", "Journal of Economic Literature"]
...
try:
    # Article Writer
    if path.exists('Articles-Journal of Economic Literature.csv') == False:
        articles_file = open('Articles-Journal of Economic Literature.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Journal of Economic Literature.csv') == False:
        authors_file = open('Authors-Journal of Economic Literature.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://www.aeaweb.org/journals/jel/issues"
driver.get(url)
