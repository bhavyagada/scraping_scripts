...
article_data = ["0920-8550", "1573-0735", "Journal of Financial Services Research"]
...
try:
    # Article Writer
    if path.exists('Articles-Journal of Financial Services Research.csv') == False:
        articles_file = open('Articles-Journal of Financial Services Research.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Journal of Financial Services Research.csv') == False:
        authors_file = open('Authors-Journal of Financial Services Research.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/10693/volumes-and-issues"
driver.get(url)
