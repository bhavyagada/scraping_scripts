...
article_data = ["1381-1231", "1572-9397", "Journal of Heuristics"]
...
try:
    # Article Writer
    if path.exists('Articles-Journal of Heuristics.csv') == False:
        articles_file = open('Articles-Journal of Heuristics.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Journal of Heuristics.csv') == False:
        authors_file = open('Authors-Journal of Heuristics.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/10732/volumes-and-issues"
driver.get(url)
