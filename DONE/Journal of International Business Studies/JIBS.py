...
article_data = ["0047-2506", "1478-6990", "Journal of International Business Studies"]
...
try:
    # Article Writer
    if path.exists('Articles-Journal of International Business Studies.csv') == False:
        articles_file = open('Articles-Journal of International Business Studies.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Journal of International Business Studies.csv') == False:
        authors_file = open('Authors-Journal of International Business Studies.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/41267/volumes-and-issues"
driver.get(url)
