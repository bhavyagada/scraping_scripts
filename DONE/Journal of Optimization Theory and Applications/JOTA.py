...
article_data = ["0022-3239", "1573-2878", "Journal of Optimization Theory and Applications"]
...
try:
    # Article Writer
    if path.exists('Articles-Journal of Optimization Theory and Applications.csv') == False:
        articles_file = open('Articles-Journal of Optimization Theory and Applications.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Journal of Optimization Theory and Applications.csv') == False:
        authors_file = open('Authors-Journal of Optimization Theory and Applications.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/10957/volumes-and-issues"
driver.get(url)
