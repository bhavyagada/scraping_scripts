...
article_data = ["0933-1433", "1432-1475", "Journal of Population Economics"]
...
try:
    # Article Writer
    if path.exists('Articles-Journal of Population Economics.csv') == False:
        articles_file = open('Articles-Journal of Population Economics.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Journal of Population Economics.csv') == False:
        authors_file = open('Authors-Journal of Population Economics.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/148/volumes-and-issues"
driver.get(url)
...
for url in issue_urls:
    ...
    for url in article_urls:
        ...
        if url_type != 'text/html':
            ...
            try:
                publication_date = driver.find_element_by_xpath("//ul[@class='c-bibliographic-information__list']/li/p[contains(text(), 'Published')]/span[2]").text
            except NoSuchElementException:
            ...
            temp_article_list = [volume, issue, document_title, document_type[i], issue_date, publication_date, manuscript_received_date, manuscript_accepted_date, digital_object_identifier, abstract, keywords_list, jel_classification]
