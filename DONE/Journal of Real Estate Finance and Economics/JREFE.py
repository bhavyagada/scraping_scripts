...
article_header = ["issn", "e_issn", "publication_name", "volume", "issue", "document_title", "document_type", 
                ...
                "manuscript_accepted_date", "digital_object_identifier", "abstract", "keywords", "jel_classification"]
article_data = ["0895-5638", "1573-045X", "Journal of Real Estate Finance and Economics"]
...
try:
    # Article Writer
    if path.exists('Articles-Journal of Real Estate Finance and Economics.csv') == False:
        articles_file = open('Articles-Journal of Real Estate Finance and Economics.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Journal of Real Estate Finance and Economics.csv') == False:
        authors_file = open('Authors-Journal of Real Estate Finance and Economics.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/11146/volumes-and-issues"
driver.get(url)
...
for url in issue_urls:
    ...
    for url in article_urls:
        ...
        if url_type != 'text/html':
            ...
            try:
                jel_class = driver.find_elements_by_xpath("//h3[contains(text(), 'JEL')]/following-sibling::ul[@class='c-article-subject-list']/li/span")
                jel_list = []
                for j in jel_class:
