...
article_data = ["0895-5646", "1573-0476", "Journal of Risk and Uncertainty"]
...
try:
    # Article Writer
    if path.exists('Articles-Journal of Risk and Uncertainty.csv') == False:
        articles_file = open('Articles-Journal of Risk and Uncertainty.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Journal of Risk and Uncertainty.csv') == False:
        authors_file = open('Authors-Journal of Risk and Uncertainty.csv', mode='a+', newline='', encoding='UTF-8')
