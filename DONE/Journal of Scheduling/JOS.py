...
article_data = ["1094-6136", "1099-1425", "Journal of Scheduling"]
...
try:
    # Article Writer
    if path.exists('Articles-Journal of Scheduling.csv') == False:
        articles_file = open('Articles-Journal of Scheduling.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Journal of Scheduling.csv') == False:
        authors_file = open('Authors-Journal of Scheduling.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/10951/volumes-and-issues"
driver.get(url)
