...
article_data = ["0023-7639", "1543-8325", "Land Economics"]
...
try:
    # Article Writer
    if path.exists('Articles-Land Economics.csv') == False:
        articles_file = open('Articles-Land Economics.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Land Economics.csv') == False:
        authors_file = open('Authors-Land Economics.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "http://le.uwpress.org/content/by/year"
driver.get(url)
...
for url in issue_urls[4:]:
    ...
    for url in issue_list:
        ...
        for url in article_urls:
            ...
            temp_article_list = [volume, issue, document_title, document_type, issue_date, publication_date, dois[i], abstract, jel_classification]
