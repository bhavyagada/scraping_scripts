...
article_data = ["0938-8249", "1861-8901", "Management International Review"]
...
try:
    # Article Writer
    if path.exists('Articles-Management International Review.csv') == False:
        articles_file = open('Articles-Management International Review.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Management International Review.csv') == False:
        authors_file = open('Authors-Management International Review.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/11575/volumes-and-issues"
driver.get(url)
    ...
    for url in article_urls:
        ...
        if url_type != 'text/html':
            ...
            try:
                ...
                try:
                    abs = []
                    abstract_list = driver.find_elements_by_xpath("//div[@id='Abs1-content']/ul/li")
            ...
            temp_article_list = [volume, issue, document_title, document_type[i], issue_date, publication_date, manuscript_received_date, manuscript_revised_date, manuscript_accepted_date, digital_object_identifier, abstract, keywords_list]
