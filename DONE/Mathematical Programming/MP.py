...
article_data = ["0025-5610", "1436-4646", "Mathematical Programming"]
...
try:
    # Article Writer
    if path.exists('Articles-Mathematical Programming.csv') == False:
        articles_file = open('Articles-Mathematical Programming.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Mathematical Programming.csv') == False:
        authors_file = open('Authors-Mathematical Programming.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/10107/volumes-and-issues"
driver.get(url)
