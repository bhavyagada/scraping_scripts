...
article_data = ["0171-6468", "1436-6304", "OR Spectrum"]
...
try:
    # Article Writer
    if path.exists('Articles-OR Spectrum.csv') == False:
        articles_file = open('Articles-OR Spectrum.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-OR Spectrum.csv') == False:
        authors_file = open('Authors-OR Spectrum.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/291/volumes-and-issues"
driver.get(url)
...
for url in issue_urls:
    ...
    for url in article_urls:
        ...
        if url_type != 'text/html':
            ...
            temp_article_list = [volume, issue, document_title, document_type[i], issue_date, publication_date, manuscript_received_date, manuscript_accepted_date, digital_object_identifier, abstract, keywords_list]
