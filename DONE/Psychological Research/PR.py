...
article_data = ["0340-0727", "1430-2772", "Psychological Research"]
...
try:
    # Article Writer
    if path.exists('Articles-Psychological Research.csv') == False:
        articles_file = open('Articles-Psychological Research.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Psychological Research.csv') == False:
        authors_file = open('Authors-Psychological Research.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/426/volumes-and-issues"
driver.get(url)
...
for url in issue_urls:
    ...
    for url in article_urls:
        ...
        if url_type != 'text/html':
            ...
            temp_article_list = [volume, issue, document_title, document_type[i], issue_date, publication_date, manuscript_received_date, manuscript_accepted_date, digital_object_identifier, abstract]
