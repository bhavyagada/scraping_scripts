...
article_data = ["0033-3123", "1860-0980", "Psychometrika"]
...
try:
    # Article Writer
    if path.exists('Articles-Psychometrika.csv') == False:
        articles_file = open('Articles-Psychometrika.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Psychometrika.csv') == False:
        authors_file = open('Authors-Psychometrika.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/11336/volumes-and-issues"
driver.get(url)
