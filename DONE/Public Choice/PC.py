...
article_data = ["0048-5829", "1573-7101", "Public Choice"]
...
try:
    # Article Writer
    if path.exists('Articles-Public Choice.csv') == False:
        articles_file = open('Articles-Public Choice.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Public Choice.csv') == False:
        authors_file = open('Authors-Public Choice.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/11127/volumes-and-issues"
driver.get(url)
