...
article_data = ["1570-7156", "1573-711X", "Quantitative Marketing and Economics"]
...
try:
    # Article Writer
    if path.exists('Articles-Quantitative Marketing and Economics.csv') == False:
        articles_file = open('Articles-Quantitative Marketing and Economics.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Quantitative Marketing and Economics.csv') == False:
        authors_file = open('Authors-Quantitative Marketing and Economics.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/11129/volumes-and-issues"
driver.get(url)
