...
article_data = ["1380-6653", "1573-7136", "Review of Accounting Studies"]
...
try:
    # Article Writer
    if path.exists('Articles-Review of Accounting Studies.csv') == False:
        articles_file = open('Articles-Review of Accounting Studies.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Review of Accounting Studies.csv') == False:
        authors_file = open('Authors-Review of Accounting Studies.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/11142/volumes-and-issues"
driver.get(url)
