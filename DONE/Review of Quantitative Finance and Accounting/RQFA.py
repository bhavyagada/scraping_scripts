...
article_header = ["issn", "e_issn", "publication_name", "volume", "issue", "document_title", "document_type", 
                "issue_date", "publication_date", "published_date", "manuscript_accepted_date", 
                "digital_object_identifier", "abstract", "keywords", "jel_classification"]
article_data = ["0924-865X", "1573-7179", "Review of Quantitative Finance and Accounting"]
...
try:
    # Article Writer
    if path.exists('Articles-Review of Quantitative Finance and Accounting.csv') == False:
        articles_file = open('Articles-Review of Quantitative Finance and Accounting.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Review of Quantitative Finance and Accounting.csv') == False:
        authors_file = open('Authors-Review of Quantitative Finance and Accounting.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/11156/volumes-and-issues"
driver.get(url)
...
for url in issue_urls:
    ...
    for url in article_urls:
        ...
        if url_type != 'text/html':
            ...
            temp_article_list = [volume, issue, document_title, document_type[i], issue_date, publication_date, published_date, manuscript_accepted_date, digital_object_identifier, abstract, keywords_list, jel_classification]
