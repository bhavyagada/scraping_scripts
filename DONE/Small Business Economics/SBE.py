...
article_data = ["0921-898X", "1573-0913", "Small Business Economics"]
...
try:
    # Article Writer
    if path.exists('Articles-Small Business Economics.csv') == False:
        articles_file = open('Articles-Small Business Economics.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Small Business Economics.csv') == False:
        authors_file = open('Authors-Small Business Economics.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/11187/volumes-and-issues"
driver.get(url)
