...
article_header = ["issn", "e_issn", "publication_name", "volume", "issue", "document_title", "document_type", 
                ...
                "manuscript_accepted_date", "digital_object_identifier", "abstract"]
article_data = ["0176-1714", "1432-217X", "Social Choice and Welfare"]
...
try:
    # Article Writer
    if path.exists('Articles-Social Choice and Welfare.csv') == False:
        articles_file = open('Articles-Social Choice and Welfare.csv', mode='a+', newline='', encoding='UTF-8')
    ...
    # Author Writer
    if path.exists('Authors-Social Choice and Welfare.csv') == False:
        authors_file = open('Authors-Social Choice and Welfare.csv', mode='a+', newline='', encoding='UTF-8')
...
url = "https://link.springer.com/journal/355/volumes-and-issues"
driver.get(url)
...
for url in issue_urls:
    ...
    for url in article_urls:
        ...
        if url_type != 'text/html':
            ...
            temp_article_list = [volume, issue, document_title, document_type[i], issue_date, publication_date, published_date, manuscript_received_date, manuscript_accepted_date, digital_object_identifier, abstract]
